...
import com.tp.shop.ao.promotion.CouponAO;
import com.tp.shop.helper.AuthHelper;
import com.tp.shop.helper.RequestHelper;
import com.tp.shop.helper.cache.SMSCacheHelper;
...
public class CouponController {
	...
	public String couponList(HttpServletRequest request){
		...
		try{
			...
			Long promoterId = promoterAO.getPromoterIdByChannelCode(coupon.getChannelcode());
			coupon.setShopId(promoterId);
