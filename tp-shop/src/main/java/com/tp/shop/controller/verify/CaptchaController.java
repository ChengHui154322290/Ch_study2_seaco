package com.tp.shop.controller.verify;
...
import com.tp.shop.ao.verify.CaptchaAO;
...
public class CaptchaController {
	...
	public void securityCode(HttpServletResponse response,QueryCaptcha queryCaptcha){
		try {
