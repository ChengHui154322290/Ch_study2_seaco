package com.tp.shop.controller.product;
...
import com.tp.shop.ao.product.ProductAO;
...
public class ProductController {
	...
	@ResponseBody
	public String getProductDetail(QueryProduct product,HttpServletRequest request){
		try{
			...
			MResultVO<ProductDetailVO> result = productAO.getProductDetail(product,channelCode);
			if(log.isInfoEnabled()){
