...
public class PropertiesHelper {
	...
	public final String offLineGroupbuyShareUrl="http://m.51seaco.com/group_detail.html?tid=532&sku=07010100050101";
	...
	public String getShareErweimaUrl(String channelCode) {
		return "http://"+channelCode+"."+shareErweimaUrl;
	}
