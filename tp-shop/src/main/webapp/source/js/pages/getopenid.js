$(function(){
	var defaultindexurl = xigou.activeHost + 'index.html';
    var back_url = decodeURIComponent(xigou.getQueryString('back_url')) || defaultindexurl;
    ...
    xigou.activeUser.getcode({
        ...
        callback:function(response){
            var back_url = response.data.codeurl;
            if (back_url){
                window.location.href = back_url;
            }
        }
