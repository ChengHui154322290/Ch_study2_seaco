...
$(function(){
	...
	//保存
	$("#saveSupplierBtn").live('click',function(){
		//校验
	...
	//删除
	$(".deleteSkuSupplierBtn").live('click',function(){
		var skuSupplierId = $(this).attr('id');
		var skuId = $(this).attr('skuId');
		$.ajax({ 
			url: 'deleteSkuSupplier.htm?skuSupplierId='+skuSupplierId, 
			dataType: 'text',
			type: "post", 
			cache : false, 
			success: function(data) {
