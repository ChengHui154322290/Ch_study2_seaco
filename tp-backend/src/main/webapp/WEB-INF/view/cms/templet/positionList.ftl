...
<@backend title="位置管理" 
    js=['/statics/cms/js/common.js',
		...
		'/statics/cms/js/templet/positionList.js'
       ] 
...
<div class="mt10" id="forms">
    <div class="box">
        <div class="box_border">
            <div class="box_top">
                <b class="pl15">CMS管理->位置管理</b> 
            </div>
            <div class="box_center">
            	<form id="contract_list_form" class="jqtransform" method="post" action="${domain}/cms/queryPositionList.htm">
                    <table cellspacing="0" cellpadding="0" border="0" width="100%"
                        ...
                        <tbody>
                            <tr>
                                        ...
                                        <div class="select_containers">
                                            <span class="fl"> <select class="select status" name="status" 
                                                style="width: 150px;">
                                                    ...
                                                    <option value="0" <#if query.status??&&query.status?string=='0'>selected='selected'</#if>>启用</option>
                                                    <option value="1" <#if query.status??&&query.status?string=='1'>selected='selected'</#if>>停用</option>
                                            </select>
                                            </span>
                                         </div>
                                     </div>
                               ...
                               <tr>
                                <td colspan="1" class="td_right" width="50" align="right">模块名称：</td>
                                <td class="" width="50" align="left"><input type="text" value="${query.templeName}"
                                    name="templeName" class="input-text lh30 templeName" size="20"></td>

								<td colspan="1" class="td_right" width="50" align="right">位置名称：</td>
                                 <td class="" width="50" align="left"><input type="text" value="${query.positionName}"
                                    name="positionName" class="input-text lh30 positionName" size="20"></td>
                            ...
                            <tr>
                                <td colspan="8" align="center">
                                    ...
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                                    <input type="button" name="button" id="positionListQuery" class="btn btn82 btn_search" value="查询">
                                </td>
                            </tr>
							...
							<tr>
                                <td >
                                    <input type="button" name="button" id="position_add" class="btn btn82 btn_add" value="创建">
                                </td>
                                <td >
                                    <input type="button" name="button" id="position_upd" class="btn btn82 btn_add" value="修改">
                                </td>
                                <!--td >
                                    <input type="button" name="button" id="position_del" class="btn btn82 btn_del" value="删除">
                                </td-->
                            </tr>
											...
											<#if (pageList?? && pageList.getRows()??)>
												<#list pageList.getRows() as page>
													<tr class="temp_tr_master">
														...
														<td class="td_center"><span class="pop_positionName">${page.positionName}</span></td>
														<td class="td_center"><span class="pop_positionCode">${page.positionCode}</span></td>
														...
														<td class="td_center"><a href="javascript:;" class="addInfo" param='${att.id}'>添加内容</a></td>
														<td style="display:none;"><span class="pop_pageId">${page.pageId}</span></td>
														<td style="display:none;"><span class="pop_templetId">${page.templeId}</span></td>
														<td style="display:none;"><span class="pop_Id">${page.id}</span></td>
														<td style="display:none;"><span class="elementType_code">${page.elementType}</span></td>
													</tr>
												</#list>
											</#if>
