					    ...
					    <tbody>
					    	<tr>
					            ...
					            <td class="td_right"><font color="red">*</font>模块名称： </td>
					             <td class=""  width="100">
					                <input type="text" maxlength="30" name="templeName" value="${page.templeName}" class="_req input-text lh30 templeName" maxlength="60" size="40">
					            </td>
					            
					            <input type="hidden" name="id" class="_req input-text lh30 templetId" value="${page.id}" >
					        </tr>
					        
					        <tr>
					            <td class="td_right"><font color="red">*</font>模块编号： </td>
					             <td class=""  width="100">
					                <input type="text" maxlength="30" name="templeCode" value="${page.templeCode}" class="_req input-text lh30 templeCode" maxlength="60" size="40">
					            </td>
					        ...
					        <tr>
					            ...
					            <td>
						            <div class="select_border">
					                	<div class="select_containers">
                                            <span class="fl"> <select class="select elementType" name="elementType" 
                                                style="width: 130px;">
                                                    <option value="">请选择</option>
					        ...
					        <tr>
					        	<td class="td_right"><font color="red">*</font>元素数量： </td>
					            <td class=""  width="100">
					                <input type="text" name="elementNum"  value="${page.elementNum}" maxlength="60" class="_req input-text lh30 elementNum" size="40">
					            </td>
					        </tr>
