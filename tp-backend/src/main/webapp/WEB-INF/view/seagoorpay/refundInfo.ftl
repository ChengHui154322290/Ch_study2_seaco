...
<title>支付信息列表</title>
<form class="jqtransform" method="post" id="queryAttForm" action="${domain}/seagoorpay/refundinfo.htm">
    <div class="box">
        <div class="box_border">
            ...
            <table id="topicSearch" cellspacing="0" cellpadding="0" border="0" width="100%" class="form_table pt15 pb15">
                ...
                <tr>
                    ...
                    <td class="" width="150" align="left">
                        <select name="status" class="select" id="status" style="width:150px">
                            ...
                            <option value="1" <#if ("${query.status}" == "1")>selected</#if>>退款中</option>
                            <option value="2" <#if ("${query.status}" == "2")>selected</#if>>退款成功</option>
                            <option value="3" <#if ("${query.status}" == "3")>selected</#if>>退款失败</option>
                ...
                <tr  >
                    ...
                    <td class="" width="150" align="left"><select class="select2" style="width:200px" id="merchantId" name="merchantId" class="input-text lh30" value="${query.merchantId!}">
                ...
                <tr>
                    <td class="td_right" width="50" align="right">退款单号:</td>
                    <td class="" width="150" align="left"><input type="text" id="refundCode" name="refundCode" class="input-text lh30" value="${query.refundCode!}" /></td>
                    <td class="td_right" width="50" align="right">商户退款单号:</td>
                    <td class="" width="150" align="left"><input type="text" id="merRefundCode" name="merRefundCode" class="input-text lh30" value="${query.merRefundCode!}" /></td>
                    <td class="td_right" width="50" align="right">时间:</td>
                    <td class="" width="150" align="left" colspan="1">
                    ...
                    <#list result.data.rows as info>
                        <tr>
                            <td class="td_center" style="width:30px;text-align:center;">
                                <span>${info.refundCode}</span>
                            </td>

                            <td class="td_center" style="width:30px;text-align:center;">
                                <span>${info.merRefundCode}</span>
                            </td>
