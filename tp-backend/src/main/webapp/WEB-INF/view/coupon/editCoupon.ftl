...
<@backend title="优惠券编辑" js=[	
    ...
    '/statics/backend/js/editorUtil.js',
	'/statics/backend/js/coupon/coupon_edit.js']   
         		...
         		<tr>
	                  ...
	                  <td >  
	                  			<span style="margin-left:20px;margin-top:20px">
	                  				<input  type="text" size="40"  class="input-text" style="width:80px;text-align: center;" name=""  value="${couponDto.id}" disabled/>
	                  			</span>
							    <span id="">
               		   		  	<span style="margin-left:380px;">状态：</span>
	               		   		  	<#assign sta="${couponDto.status}" />
				              		<#if sta=='0'>编辑中
				              		<#elseif sta=='1'>审核中
				              		<#elseif sta=='2'>已取消
				              		<#elseif sta=='3'>审核通过
               ...
               <tr>
                  <td style="width:120px;vertical-align: top;" align="left">*优惠券类型：</td>  
                   <td style="border: 1px dashed #BBBBBB;">        
                   		   		  ...
                   		   		  <input id="show_face_input" type="text" size="40"  class="input-text" style="width:80px;" name=""  value="${couponDto.faceValue}" disabled/>
								  <span id="show_choose_over_value">
                   		   		  <span style="margin-left:80px;">优惠券需满金额：</span>
                   		   		  <input id="show_over_input" type="text" size="40"  class="input-text" style="width:80px;" name=""  value="${couponDto.needOverMon}" disabled/>
								   </span>
								  </br>
								  </br>
								  <span style="margin-left:20px;margin-top:50px">发行量：</span>
								  <input type="text" size="40" class="input-text lh30 couponCount" style="width:70px;margin-left:80px;" name="name"  maxlength="18" value='${couponDto.couponCount}'/>&nbsp;&nbsp;张（-1 表示不限量）
								  </br>
								  </br>
                   </td>
                </tr>
                <tr  id="type_choose" style="margin=top:20px;">   
              		...
              		<td class="" style="margin-top:20px; "  >    
	                    ...
	                    <input id="over_type" type="text" size="40"  class="input-text" style="width:150px;margin-left:30px;" name="name"  value="请输入满减券名称"/>
	                    <span class="over_type_span">满 </span> 
						  <input id="over_type_input_over" type="text" size="40"  class="input-text" style="width:80px;display:inline-block;" name=""  value="${couponDto.needOverMon}"/>
						  <span class="over_type_span">元减</span> 
						   <input id="over_type_input_face" type="text" size="40"  class="input-text" style="width:80px;display:inline-block;" name=""  value="${couponDto.faceValue}"/>
	                     ...
	                     <input id="cash_type" type="text" size="40" class="input-text" style="width:150px;margin-left:30px;" name="name"  value="输入现金券名称"/>  
						  ...
						  <input id="cash_type_input_face" type="text" size="40"  class="input-text" style="width:80px;display:inline-block;" name=""  value="${couponDto.faceValue}"/>
						 <span class="exchangeXgMoney">&nbsp;&nbsp;是否允许兑换西客币</span>    
						  <select class="select exchangeXgMoney" name="exchangeXgMoney" id="exchangeXgMoney" style="width:100px;" >
                            <option value="0" <#if (((couponDto.exchangeXgMoney)!'') == '0')>selected="selected"</#if> >否</option>
                            <option value="1" <#if (((couponDto.exchangeXgMoney)!'') == '1')>selected="selected"</#if>>是</option>
                           </select>
                ...
                <tr>
                  ...
                  <td class="">
 					<input type="text" id="coupon_release_stime" size="20" class="input-text lh20" name="name" value='${couponDto.couponReleaseStime?string("yyyy-MM-dd")}' readonly />&nbsp;&nbsp;到&nbsp;&nbsp;
 					<input type="text" id="coupon_release_etime" size="20" class="input-text lh20" name="name" value='${couponDto.couponReleaseEtime?string("yyyy-MM-dd")}' readonly />
                  </td>
                 </tr>
                 ...
                 <tr>
                  <td class="td_left">*优惠券使用时间</td>
	                  <td class="">
		 				...
		 				<input id="coupon_use_stime" type="text" size="20" <#if couponDto.couponUseStime ??> value='${couponDto.couponUseStime?string("yyyy-MM-dd")}'</#if> class="input-text lh20" name="name" readonly /><span class="coupon_use_time">&nbsp;&nbsp;到&nbsp;&nbsp;</span>
	 					<input id="coupon_use_etime" type="text" size="20"  <#if couponDto.couponUseEtime ??>  value='${couponDto.couponUseEtime?string("yyyy-MM-dd")}'</#if>   class="input-text lh20" name="name" readonly />
                ...
                <tr>
                 ...
                 <tr>
                  ...
                  <td class="">
                    ...
                    <#--<input name="use_plantform" type="checkbox" value="0" id="platAll"> 全网-->
                    <#--<input name="use_plantform" type="checkbox" value="1" id="platPc"> PC-->
                    <#--<input name="use_plantform" type="checkbox" value="2" id="platApp"> APP-->
                    <#--<input name="use_plantform" type="checkbox" value="3" id="platWap"> WAP-->
                    <#--<input name="use_plantform" type="checkbox" value="4" id="platHapPreg"> 快乐-->
                ...
                <tr>
                 ...
                 <tr>
                  ...
                  <td class="">
                    <input name="source_type" class="source_type" type="radio" value="1" id="source_type_1"  > 西客商城
                ...
                <tr>
                    ...
                    <td class="">
                        ...
                        <span id="showReceiveSpan" >
                                                                      是否在领券专区显示     <input name="isShowReceive" type="radio"   value="2" <#if (((couponDto.isShowReceive)!'') == '2')>checked="checked"</#if>/>&nbsp;&nbsp;是&nbsp;&nbsp;
	 					<input name="isShowReceive" type="radio" value="1" <#if (((couponDto.isShowReceive)!'') == '1')>checked="checked"</#if>/>&nbsp;&nbsp;否
                        </span>
                    </td>
                </tr>
				<tr title="实体卡券请选择不激活,监制完成后再激活">
                    ...
                    <td class="">
                        <input name="activeStatus" type="radio"  value="0"/>&nbsp;&nbsp;不激活&nbsp;&nbsp;
	 					<input name="activeStatus" type="radio" value="1"/>&nbsp;&nbsp;激活
                    </td>
                </tr>
                <tr>
                  ...
                  <td style="border: 1px dashed #BBBBBB;">
                  				   ...
                  				   <br/>
                   		   		   <span id="coupon_range_span">
                   		   		    <input name="useScope" type="radio"  value="4"  <#if (((couponDto.useScope)!'') == '4')>checked="checked"</#if> />&nbsp;&nbsp;类别&nbsp;&nbsp;<br>
								  ...
								  <span id="brand_span_2" name="brand_span_2">
								     <input name="useScope" type="radio"  value="3"  <#if (((couponDto.useScope)!'') == '3')>checked="checked"</#if>/>&nbsp;&nbsp;品牌&nbsp;&nbsp;<br>
								     <span id="add_brand" name="add_brand" title="增加" style="margin-left: 10px;margin-right: 10px;cursor: pointer"class="add_coupon_icon">  </span>|
									 <span id="remove_brand" name="remove_brand" title="删除" style="margin-left: 10px;margin-right: 10px;cursor: pointer" class="remove_coupon_icon">  </span>
								 	 ...
								 	 <input type="text" class="input-text lh30 brandId" style="width:50px;margin-left: 20px;"  id="default_brand_id"/>
								  	 <input type="text" size="40" class="input-text lh30 brandName" style="width:120px;margin-left:20px;" name="name" id="default_brand"/>
									 &nbsp;&nbsp;
								   ...
								   <span id="sku_span_2" name="sku_span_2">
								    <input name="useScope" type="radio"  value="1"  <#if (((couponDto.useScope)!'') == '1')>checked="checked"</#if>/>&nbsp;&nbsp;商品&nbsp;&nbsp;<br>
									   ...
									   <select class="select itemLevelSelect" name="item_sku"  style="width:50px;margin-left:20px;">  
								   		...
								   		<input type="text" size="40" class="input-text lh30" style="width:120px;margin-left:20px;" maxlength="20" name="typeCode" id="default_sku"/>
									  </br>
									  </br>
								   </span>
								   </span>
								   ...
								   <input name="useScope" type="radio" value="2"  <#if (((couponDto.useScope)!'') == '2')>checked="checked"</#if> />&nbsp;&nbsp;专场&nbsp;&nbsp;<br>
                  ...
                  <td style="border: 1px dashed #BBBBBB;">
                  				   <br/>
                   		   		   ...
                   		   		   <span id="category_span_1_no">
                   		   		  	<span id="category_span_0_no" name="category_span_2_no">
									 ...
									 <span  name="remove_category_no" title="删除" style="margin-left: 10px;margin-right: 10px;cursor: pointer" class="remove_coupon_icon">  </span>
	                   		   		  <span style="margin-left:20px;margin-top:20px">类别：</span>
	                   		   		  <span style="margin-left:20px;margin-left:20px">大类</span>
	                   		   		  <select class="select largeIdSel"  style="margin-left:10px;width:100px;" >  
	   		   		  						<option value="">--请选择分类--</option>
											<#list categoryList as category>
												<option value="${category.id}">${category.name}</option>
											</#list>
	                   		   		   ...
	                   		   		   <span style="margin-left:10px;">中类：</span>
	                   		   		   <select class="select mediumIdSel"  style="width:100px;" >  
	                   		   		   			<option value="">--请选择分类--</option>
									   </select>
								  	   <span style="margin-left:10px;">小类：</span> 
	                   		   		   <select class="select smallIdSel"  style="width:100px;" >  
	                   		   		   			<option value="">--请选择分类--</option>
									   </select>
									  </br>
									  </br>
								  ...
								  <span id="brand_span_2_no" name="brand_span_2_no">
								     <span id="add_brand_no" name="add_brand_no" title="增加" style="margin-left: 10px;margin-right: 10px;cursor: pointer"class="add_coupon_icon">  </span>|
									 <span id="remove_brand_no" name="remove_brand_no" title="删除" style="margin-left: 10px;margin-right: 10px;cursor: pointer" class="remove_coupon_icon">  </span>
								 	 <span style="margin-left:20px;margin-top:50px">品牌：</span>
								 	 <input type="text" class="input-text lh30 brandId" style="width:50px;margin-left: 20px;"  id="default_brand_id_no"/>
								  	 <input type="text" size="40" class="input-text lh30 brandName" style="width:120px;margin-left:20px;" name="name" id="default_brand_no"/>
									 &nbsp;&nbsp;
									 <input type="button" class="btn btn82 btn_save2 confirmBrand" id="" value="确定" />
									 <input type="button" class="btn btn82 btn_search searchBrand" id="" value="查询" />
								  	</br>
								   ...
								   <span id="sku_span_2_no" name="sku_span_2_no">
									   ...
									   <span style="margin-left:20px;margin-top:50px">商品：</span>
									   <select class="select itemLevelSelect" name="item_sku_no"  style="width:50px;margin-left:20px;">  
												<option value="0">sku</option> 
									    </select>
								   		<input type="text" size="40" class="input-text lh30" style="width:120px;margin-left:20px;" maxlength="20" name="typeCode_no" id="default_sku_no"/>
										  </br>
										  </br>
								   </span>
								   </span>
								  ...
								  <span id="sku_span_copy_no" style="display:none;">
								   <span id="sku_span_2_no" name="sku_span_2_no">
									   ...
									   <select class="select itemLevelSelect" name="item_sku"  style="width:50px;margin-left:20px;">  
								   		...
								   		<input type="text" size="40" class="input-text lh30" style="width:120px;margin-left:20px;" maxlength="20" name="typeCode_no" />
										  </br>
										  </br>
								   </span>
								   </span>
                 ...
                 <tr>
                   ...
                   <br/>
                   <br/>
                     <input name="button" class="btn btn82 btn_save2 datasubmit" value="保存" type="button" id='datasubmit' value="保存" param='/coupon/updateCoupon.htm' status='0'> 
                     <input name="button" class="btn btn82 btn_res datasubmit" value="提交" type="button" id="reset" param='/coupon/updateCoupon.htm' status='1'/> 
                     <input name="button" class="ext_btn" value="返回" type="button" id="cancel_page" /> 
                     <!-- <span id="can_edit_info" style="color:red;margin-left:10px;display:none;"><strong>*</strong>由于此优惠券批次已经被发放过，不能被编辑！</span>  -->
                     <input type="hidden" id="dto" value='${infos}' />   
                     <input type="hidden" id="conponId" value='${couponDto.id}'/>  
