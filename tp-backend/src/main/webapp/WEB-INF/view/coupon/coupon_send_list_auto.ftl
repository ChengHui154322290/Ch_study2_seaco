...
<@backend title="优惠券自动发放列表" 
    js=[
	'/statics/backend/js/layer/layer.min.js',
	'/statics/backend/js/coupon/coupon_send_auto.js']  
    css=[] >
<form class="jqtransform" method="post" id="queryAttForm" action="${domain}/coupon/auto/sendList.htm">
		   <div >
			   <div>	
                                 ...
                                 <td align="left">
                                    <div class="select_border">
                                        <div class="select_containers">
                                            <span class="fl"> 
                                            <select class="select" name="type" style="width: 130px;">
                	 ...
                	 <table width="100%" border="0" cellpadding="0" cellspacing="0" class="list_table">
						               ...
						               <#list queryAllCouponSendByPage.getRows() as cdo>
						                <tr class="tr" >
								              ...
								              <td class="td_center"><#assign type="${cdo.type}" /> <#if (type ==1)>新用户注册</#if><#if (type ==2)>用户分享</#if> </td>
								               <td class="td_center">${(cdo.startTime?string("yyyy-MM-dd"))!''} - ${(cdo.endTime?string("yyyy-MM-dd"))!''}</td>
