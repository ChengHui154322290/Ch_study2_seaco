...
<@backend title="优惠券发放" 
			js=[ '/statics/backend/js/jqueryui/js/jquery-ui-1.9.2.custom.min.js',  
				...
				'/statics/backend/js/coupon/couponIssue_auto.js',
	...
	<div class="mt10" id="forms">
	    <div class="box">
	        <div class="box_border">
	            <div class="box_top">
	                <b class="pl15">促销管理->优惠券->优惠券自动发放</b> 
	            </div>
	                ...
	                <tr>
		                  ...
		                  <td >  <span style="margin-left:20px;margin-top:20px">自动生成</span>
										  <span id="">
							                        ...
							                        <option value="1"selected='selected'>新用户注册</option>
							                        <option value="2">用户分享</option> 
                                            	</select>
										  </span>
										  <span id="">
									  	...
									  	<span id="">
	                   		   		  		...
	                   		   		  		<input type="text" id="start_time" size="20" class="input-text lh20" name="startTime" readonly />&nbsp;&nbsp;到&nbsp;&nbsp;
 											<input type="text" id="end_time"  size="20" class="input-text lh20" name="endTime" readonly /> 
									  </span>
						</td>
	               </tr>
