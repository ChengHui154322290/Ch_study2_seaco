...
<@backend title="商户查询" 
		js=['/statics/backend/js/coupon/supplier_search.js',
	...
	<table cellspacing="0" cellpadding="0" border="0" width="100%" class="form_table pt15 pb15">
		<tr>
			<td class="td_right" width="50" align="right">ID:</td>
			<td width="50" align="left">
				<input type="text" class="input-text lh30" id="id" name="id" value="" />
			</td>
			<td class="td_right" width="50" align="right">商户名:</td>
			<td width="50" align="left">
		...
		<tr>
			<td colspan="2" align="right">
				<div style="padding-right:10px">
					<input type="button" class="btn btn82 btn_save2" id="save_source" value="确认" />
				</div>
			</td>
			<td align="left">
