...
<form method="post" action="${domain}/dss/withdrawdetail/audit.htm" id="withdrawauditform">
<input type="hidden" name="withdrawDetailId" value="${withdrawDetailId}"/>
<input type="hidden" name="oldStatus" value="${withdrawStatus}"/>
<input type="hidden" name="withdrawDetailCode" value="${withdrawDetailCode}"/>
		...
		<div class="box_border">
			...
			<div class="box_bottom pb5 pt5 pr10" style="border-top: 1px solid #dadada;">
				<div class="search_bar_btn" style="text-align: center;">
					<input type="button" value="审核" class="btn btn82 btn_add withdrawauditbtn" name="button" id="withdrawauditbtn">
				</div>
			</div>
			<div class="box_center pt10 pb10">
				<table id="withdrawloglist" class="withdrawloglist scroll"></table>
			</div>
		</div>
	</div>
</div>
