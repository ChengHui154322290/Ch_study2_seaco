...
<head>
  <meta charset="UTF-8">
  <link rel="stylesheet" href="${domain}/statics/themes/msgbox.css">
   ...
   <link rel="stylesheet" href="${domain}/statics/js/validation/jquery.validate.min.css">
   ...
   <script type="text/javascript" charset="utf-8" src="${domain}/statics/js/validation/jquery.validate.min.js"></script>
   <script type="text/javascript" charset="utf-8" src="${domain}/statics/js/validation/jquery.validate.method.min.js"></script>
   <script>var domain = "${domain}";var backendDomain="${domain}";</script>
		<#list css as file>   
