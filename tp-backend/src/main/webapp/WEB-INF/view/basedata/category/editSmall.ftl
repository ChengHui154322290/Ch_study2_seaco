              ...
              <form class="jqtransform" method="post" id="catEdit">
               ...
               <!--   <input type='hidden' name='level' value='${level}'> -->
				...
				<td valign="middle" align="left">
					<input id="at5" type="radio" name="status"  <#if category.status="true">checked</#if>  value="1"/>
					<label for="at5" >有效</label>
					<input id="at6" type="radio" name="status"  <#if category.status !="true"> checked</#if> value="0"/>
                 ...
                 <tr>
					<td>规格组</td>
					<td>
						<a href="javascript:void(0);"   class="editcatabtn " param='${category.id}' onclick="addCataSpecGroupLinked(this)">新增/查看</a>
					</td>
				</tr>
			</table>
