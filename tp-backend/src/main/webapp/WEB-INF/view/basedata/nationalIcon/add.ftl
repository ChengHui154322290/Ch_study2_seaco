...
<@backend title="" js=[	
    ...
    <div >
	   <div>	 
	   <ul id="errorlist"></ul> 
	     <form action="${domain}/basedata/brand/add" class="jqtransform"  method="post"  id='nationalIconupdate'   > 
				   ...
				   <td class="td_left">
						<div class="box_bottom pb5 pt5 pr10" style="border-top:0px solid #dadada;">
		                 <div class="search_bar_btn" style="text-align:right;">
		                   <input class="btn btn82 btn_save2 " type="button"  id='datasubmit' value="保存" param='/basedata/nationalIcon/addNationalIconSubmit.htm' />
		                 </div>
		                </div>
                  </td> 
