...
<@backend title="" js=[	
    ...
    <div >
	   <div>	  
	     <form action="${domain}/basedata/dictionaryCategory/add" class="jqtransform"  method="post"  id='dictionaryCategoryupdate'  > 
	       <table class="form_table" border="0" cellpadding="0" cellspacing="0">
		        <tr>
					<td class="td_right">类别码:</td>
					<td><input type="text" name="code" id='code' class="input-text lh25" size="20" > 
				   ...
				   <td class="td_left">
						<div class="box_bottom pb5 pt5 pr10" style="border-top:0px solid #dadada;">
		                 <div class="search_bar_btn" style="text-align:right;">
		                   <input class="btn btn82 btn_save2" type="button" id='datasubmit' value="保存" param='/basedata/dictionary/category/addDictionaryCategorySubmit.htm'  />
		                 </div>
		                </div>
                  </td> 
