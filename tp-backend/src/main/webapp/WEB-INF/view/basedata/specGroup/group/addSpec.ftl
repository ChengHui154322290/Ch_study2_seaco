...
<@backend title="" js=[	
	...
	'/statics/backend/js/formValidator/style/validator.css'
       ...
       <div >
	   <div>	  
	     <form action="${domain}/basedata/spec/add" class="jqtransform"  method="post"  id='specupdate'  >
            ...
            <!--     <table class="form_table" border="0" cellpadding="0" cellspacing="0">-->
              <!--       <tr>-->
               <!--          <td class="td_left"><input type="text" name="specGroupName" id="specGroupName" class="input-text lh25" size="20"></td>-->
			  <!--		   <td><a href="javascript:void(0);" class="specGroupSerarchbtn">搜索</a> &nbsp;&nbsp;-->
			  <!--		       <a href="javascript:void(0);" >新增</a>-->
			  <!--		   </td>-->
               <!--       </tr>-->
                 <!--  	<tr><td><div id="addcheckbox"></div>  </td></tr>-->
                <!--   </table>-->
              <!--   </td>-->
	          </tr>
          </table>
