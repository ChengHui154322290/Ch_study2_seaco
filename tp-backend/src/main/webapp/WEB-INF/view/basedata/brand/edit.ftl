	     ...
	     <form action="${domain}/basedata/brand/update" class="jqtransform"  method="post"  id='brandupdate'  > 
	       ...
	       <table class="form_table" border="0" cellpadding="0" cellspacing="0">
		        <tr>
					...
					<td><input type="text" name="name" id='name' class="input-text lh25" size="20" value='${brand.name}'>
				...
				<tr>
				  ...
				  <td><input type="text" name="nameEn" id="nameEn" class="input-text lh25" size="20" value='${brand.nameEn}'></td>
				...
				<tr>
				  ...
				  <td><input type="text" name="remark"  id="remark"  class="input-text lh25" size="20" value='${brand.remark}'></td>
				  <td><div id="remarkTip" style="width:250px"></div></t
				</tr>
				<tr>   
                   <#assign sts="${brand.status}" />
				...
				<td  class="td_center">
				  <div class="main_left m10 span6">
				  	<div class="sel_box" id="imguplod"  style="width: 200px;height: 200px"><img id='old' src="${brand.logo}" /></div>
	        	  </div>
				</td>
				</tr>
				<tr>
