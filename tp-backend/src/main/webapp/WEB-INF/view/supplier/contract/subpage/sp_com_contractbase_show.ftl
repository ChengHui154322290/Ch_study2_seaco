    ...
    <tbody>
        <tr>
            ...
            <td align="left" nowrap>
                <input type="text" name="supplierId"  id="all_page_add_supplier_id" readOnly="readOnly" value="${(contractVO.supplierId)!}" class="input-text lh30" size="5">
                <input type="text" name="supplierName" id="all_page_add_supplier_name" readOnly="readOnly" value="${(contractVO.supplierName)!}" class="input-text lh30" size="10">
        ...
        <tr>
            ...
            <td align="left">${(contractVO.templateName)!}
            </td>
            <td class="td_right" align="left">签约日期：</td>
            <td class="" width="100" align="left" colspan="3">
                <input type="text" name="signingDate" value="${(contractVO.signingDate?string("yyyy-MM-dd"))!}" id="c_signingDate" readOnly="readOnly" class="input-text lh30" size="20">
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="" nowrap>
                <#if (contractVO.contractCode)?exists>
                    ${(contractVO.contractCode)!}
                </#if>
            </td>
            <td class="td_right" align="left" nowrap><font color="red">*</font>有效期：</td>
            <td class="" align="left" nowrap>
                <input type="text" name="startDate" id="c_starDate_0" value="${(contractVO.startDate?string("yyyy-MM-dd"))!}" readOnly="readOnly" class="input-text lh30" size="20">&nbsp;到&nbsp;
                <input type="text" name="endDate" id="c_endDate_0" value="${(contractVO.endDate?string("yyyy-MM-dd"))!}" readOnly="readOnly" class="input-text lh30" size="20">
            </td>
        ...
        <tr>
            ...
            <td class="" nowrap>
                <input type="text" name="contractDesc" readOnly="readOnly" class="input-text lh30" size="33" value="${(contractVO.contractDesc)!}">
            </td>
            <td class="td_right" nowrap><font color="red">*</font>合同名称：</td>
            <td nowrap>
                <input type="text" class="_req input-text lh30" readOnly="readOnly" size="29" name="contractName" value="${(contractVO.contractName)!}">
            </td>
...
<table class="form_table pt15 pb15" cellspacing="0" cellpadding="0" border="0" width="100%">
    <tbody>
        ...
        <#--商品范围-->
        <tr>
            <td colspan="6" align="left"><font color="red">*</font>商品范围
            </td>
        </tr>
        <tr>
...
<#--资质证明-->
<div id="zzInfoTr">
<#if (contractVO.contractQualificationsVOMap)?exists>
<#list (contractVO.contractQualificationsVOMap)?keys as tagKey>
<table width="100%" cellspacing="0" cellpadding="0" style="width:495px;display:none;" class="form_table pt15 pb15" name="zzInfoTable" id="zzzm_${(tagKey)!}">
    <tbody>
        <#assign countIndex=1> 
        <#list contractVO.contractQualificationsVOMap[tagKey] as quaItem>
        <#if countIndex == 1>
            <tr>
	            <td colspan="3">资质证明&nbsp;&nbsp;&nbsp;${(quaItem.brandName)!}&nbsp;&nbsp;${(quaItem.bigName)!}
	            </td>
	        </tr>
	        <tr>
	            ...
	            <td  width="30%">${(quaItem.papersName)!}<input type="hidden" name="quaName${(tagKey)!}_${(quaItem.papersId)!}" value="${(quaItem.papersName)!}">
	            </td>
	            <td align="left">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="width:1285px;">
                <tbody id="settlementruleInfo" name="settlementrule">
                    <tr id="contractsettlementrule_${countIndex}">
                        ...
                        <td style="width: 90px;">
                            <input type="text" name="day" id="day_${countIndex}" value="${(settleRule.day)!}" class="_req input-text lh30" size="10" onchange="ruleDay();"/>
                        </td>
                        ...
                        <td  style="width: 90px;">
                            <input type="text" name="percent" id="percent_${countIndex}" value="${(settleRule.percent)!}" class="_req input-text lh30" size="10" onchange="rulePercent();">
                        </td>
                        <td align="left">
                        </td>
                        <td>
    ...
    <tr align="left">
        <td>
	        <table width="100%" border="0" cellspacing="0" cellpadding="0" id="contractcostinfos" style="width:1085px;">
	            <#if (contractVO.contractCostVOList)?exists> 
			    <#assign countIndex=1000> 
			    <#assign countIndexShow=1>
			    <#list contractVO.contractCostVOList as contractCost>
	            <tr id="contractCostInfo_${countIndex}" name="costinfo">
	                <td  align="center" width="550">
                        ...
                        <input type="text" name="value" id="basevalue" value="${(contractCost.value)!}" class="input-text lh30" size="20">
                  		      币种：
...
<table cellspacing="0" cellpadding="0" border="0" width="25%" class="form_table pt15 pb15" >
    <tbody>
        <tr>
           <td>保证金：</td><td><input type="text" size="10" class="input-text lh30" value="${(contractVO.cash)!}" readOnly="readOnly" name="contractDeposit"></td>
           <td>币种：</td>
           <td>
               <select class="_req select" style="width: 100px;" name="currency" id="costCurrency" >
                    <#list currencyTypes?keys as key>
		    ...
		    <td colspan="3">
		        <table id="supplier_link_table">
		            <tr>
						...
						<td width="100"> <input type="text" size="40" class="input-text lh30" readOnly="readOnly" value="${(contractVO.contractProperties.spMobilePhone)!}" name="supplierLinkMobile" /></td>
						<td class="td_right">电子邮箱：</td>
						<td> <input type="text" size="40" class="input-text lh30" readOnly="readOnly" value="${(contractVO.contractProperties.spEmail)!}" name="supplierLinkEmail" /></td>
					</tr>
					<tr id="supplier_link_tr3_2">
						<td class="td_right">固定电话：</td>
						<td width="100"> <input type="text" size="40" class="input-text lh30" readOnly="readOnly" value="${(contractVO.contractProperties.spTelephone)!}" name="supplierLinkTel" /></td>
						<td class="td_right">传真号码：</td>
						<td> <input type="text" size="40" class="input-text lh30" readOnly="readOnly" value="${(contractVO.contractProperties.spFax)!}" name="supplierLinkFaq" /></td>
					</tr>
					<tr id="supplier_link_tr4_2">
						<td class="td_right">地址：</td>
						<td width="100"> <input type="text" size="40" class="input-text lh30"  readOnly="readOnly" value="${(contractVO.contractProperties.spLinkAddress)!}" name="supplierLinkAddr" /></td>
						<td class="td_right">QQ：</td>
						<td> <input type="text" size="40" class="input-text lh30"  readOnly="readOnly" value="${(contractVO.contractProperties.spQq)!}" name="supplierLinkQQ" /></td>
					</tr>
		        </table>
		    </td>
		</tr>
		...
		<tr>
		    <td colspan="3">
		        <table id="mt_user_link_table">
		            <tr>
						<td class="td_right">手机号码：</td>
						<td width="100"> <input type="text" size="40" class="_req input-text lh30" readOnly="readOnly" value="${(contractVO.contractProperties.xgMobilePhone)!}" name="xgLinkMobile" /></td>
						<td class="td_right"><font color="red">*</font>电子邮箱：</td>
						<td> <input type="text" size="40" class="input-text lh30" readOnly="readOnly" value="${(contractVO.contractProperties.xgEmail)!}" name="xgLinkEmail" /></td>
					</tr>
					<tr>
						<td class="td_right"><font color="red">*</font>固定电话：</td>
						<td width="100"> <input type="text" size="40" class="_req input-text lh30"  readOnly="readOnly" value="${(contractVO.contractProperties.xgTelephone)!}" name="xgLinkTel" /></td>
						<td class="td_right">传真号码：</td>
						<td> <input type="text" size="40" class="input-text lh30"  readOnly="readOnly" value="${(contractVO.contractProperties.xgFax)!}" name="xgLinkFaq" /></td>
					</tr>
					<tr>
						<td class="td_right"><font color="red">*</font>地址：</td>
						<td width="100"> <input type="text" size="40" class="input-text lh30"  readOnly="readOnly" value="${(contractVO.contractProperties.xgLinkAddress)!}" name="xgLinkAddr" /></td>
						<td class="td_right">QQ：</td>
						<td> <input type="text" size="40" value="${(contractVO.contractProperties.xgQq)!}"  readOnly="readOnly" class="input-text lh30" name="xgLinkQQ" /></td>
					</tr>
		        </table>
		    </td>
		</tr>
		    ...
		    <td colspan="2">
		        <table>
		            <tr id="supplierBankTrArea">
						...
						<td width="100"> <input type="text" size="20" class="input-text lh30" readOnly="readOnly" value="${(contractVO.contractProperties.bankName)!}" name="contractBankName" /></td>
						<td class="td_right">银行账号：</td>
						<td> <input type="text" size="20" class="input-text lh30" readOnly="readOnly" value="${(contractVO.contractProperties.bankAccount)!}" name="contractBankAccount" /></td>
						<td class="td_right">开户名称：</td>
						<td width="100"> <input type="text" size="20" class="_req input-text lh30" readOnly="readOnly" value="${(contractVO.contractProperties.bankAccName)!}" name="contractAccountName" /></td>
		    ...
		    <td colspan="2">
		        <table id="invoiceNameTrArea">
		            <tr>
						...
						<td width="100"> <input type="text" size="40" class="input-text lh30" value="${(contractVO.contractProperties.spTaxpayerCode)!}" readOnly="readOnly" name="taxpayerCode" /></td>
						<td class="td_right">开户银行：</td>
						<td> <input type="text" size="40" class="input-text lh30" value="${(contractVO.contractProperties.spBankName)!}" readOnly="readOnly" name="kpBank" /></td>
					</tr>
					<tr>
						<td class="td_right">开户名称：</td>
						<td width="100"> <input type="text" size="40" class="input-text lh30" value="${(contractVO.contractProperties.spBankAccName)!}" readOnly="readOnly" name="kpAccountName" /></td>
						<td class="td_right">开户银行账号：</td>
						<td> <input type="text" size="40" class="input-text lh30" value="${(contractVO.contractProperties.spBankAccount)!}" readOnly="readOnly" name="kpAccount" /></td>
					</tr>
					<tr>
						<td class="td_right">联系电话：</td>
						<td width="100"> <input type="text" size="40" value="${(contractVO.contractProperties.spLinkPhone)!}" readOnly="readOnly"  class="input-text lh30" name="kpTel" /></td>
						<td class="td_right">联系地址：</td>
						<td> <input type="text" size="40" class="input-text lh30" value="${(contractVO.contractProperties.spInvoiceLinkAddress)!}" readOnly="readOnly" name="kpAddress" /></td>
					</tr>
		        </table>
		    </td>
		</tr>
