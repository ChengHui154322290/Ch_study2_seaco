...
.pb15 {
    ...
    <div class="box">
        <div class="box_border">
            <div class="box_top">
                <b class="pl15">查看代销退货单</b>
            </div>
            <div class="box_center" style="margin-bottom: 30px;">
                <#include "/supplier/order/subpage/sp_com_sellorderback_base_edit.ftl" />
                <#include "/supplier/order/subpage/show/sp_com_sellorderback_item_show.ftl" />
