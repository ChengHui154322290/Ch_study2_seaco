...
.pb15 {
    ...
    <div class="box">
        <div class="box_border">
            <div class="box_top">
                <b class="pl15">查看采购退货单</b>
            </div>
            <div class="box_center" style="margin-bottom: 30px;">
                <#include "/supplier/order/subpage/sp_com_purchaseorderback_base_edit.ftl" />
                <#include "/supplier/order/subpage/show/sp_com_purchaseorderback_item_show.ftl" />
                ...
                <form class="jqtransform" action="/supplier/purchaseorderbackSave.htm" id="order_form">
