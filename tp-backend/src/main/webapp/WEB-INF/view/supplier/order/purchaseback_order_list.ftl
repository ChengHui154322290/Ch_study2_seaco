...
<@backend title="采购退单列表" 
    js=['/statics/supplier/js/common.js',
        '/statics/backend/js/jqueryui/js/jquery-ui-1.9.2.custom.min.js',
        '/statics/backend/js/jqueryui/i18n/jquery.ui.datepicker-zh-CN.js',
        '/statics/supplier/js/validator.js',
        '/statics/supplier/js/web/purchaseback_order_list.js'
       ] 
    css=['/statics/backend/js/jqueryui/css/cupertino/jquery-ui-1.9.2.custom.min.css'] >
     <div class="box_top">
                <b class="pl15">采购管理->采购->采购退货单</b> 
     </div>       
     <form id="purchase_orderback_list_form" class="jqtransform" action="${domain}/supplier/purchaseorderbackList.htm" method="post">
                            ...
                            <tr>
                               ...
                               <td class="td_right" width="50" align="left">退单确认：</td>
                                ...
                                <td align="left" colspan="3">
                                   <input type="text" id="c_starDate_6" name="startTime" class="_dateField input-text lh30" size="20" value="<#if purchaseDO.startTime??>${purchaseDO.startTime?string("yyyy-MM-dd")}</#if>">&nbsp;~&nbsp;<input type="text" id="c_endDate_6" name="endTime" class="_dateField input-text lh30" size="20" value="<#if purchaseDO.endTime??>${purchaseDO.endTime?string("yyyy-MM-dd")}</#if>">
                                </td>
                            </tr>

                            <tr>
                                <td colspan="8" align="center"><input type="reset" id="purchaseOrderBackListQueryReset"
                                    name="button" class="btn btn82 btn_res" value="重置">
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                                    <input type="button"
                                        name="button" id="purchaseOrderBackListQuery" class="btn btn82 btn_search" value="查询">
                                </td>
                            </tr>
                        </tbody>
                    </table>
                    <div class="search_bar_btn  pt10 pb10 box_border" style="padding-left:5px;">
                		<input type="button" name="button" id="purchase_orderback_list_add_btn" class="btn btn82 btn_add" value="新增">&nbsp;&nbsp;
                ...
                <table width="100%" cellspacing="0" cellpadding="0" border="0"
            		...
            		<@pager  pagination=page  formId="purchase_orderback_list_form"  /> 
                </form>           
