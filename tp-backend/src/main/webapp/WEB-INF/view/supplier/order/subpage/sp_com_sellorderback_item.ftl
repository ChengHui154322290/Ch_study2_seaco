    ...
    <table  cellspacing="0" cellpadding="0" width="100%" class="list_table CRZ" >
        ...
        <tbody id="sp_order_table_body_1">
             ...
             <tr align="center" id="addQuotaItemTr_${countIndex}">
                ...
                <td>
                    <input type="text" size="5" value="${(product.standardPrice)!}" name="standardPrice" readOnly="readOnly" class="_req input-text lh30">
                </td>
                <td>
                    <input type="text" size="5" value="${(product.discount)!}" name="discount" readOnly="readOnly" class="_req input-text lh30">
                </td>
                <td>
                    <input type="text" size="5" value="${(product.orderPrice)!}" name="orderPrice" readOnly="readOnly" class="_req input-text lh30">
                </td>
                <td>
                    <input type="text" size="5" value="${(product.subtotal)!}" name="subtotal" readOnly="readOnly" class="_req input-text lh30">
                </td>
