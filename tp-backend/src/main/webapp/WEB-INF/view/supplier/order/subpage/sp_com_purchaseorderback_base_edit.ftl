<table cellspacing="0" cellpadding="0" border="0" width="100%" class="form_table pt15 pb15">
    <tbody>
        <tr>
            <td class="td_right">退货单编号： </td>
            <td class="" width="350">
                <span>${purchaseVO.id}</span>
            </td>
            <td class="td_right" align="left" width="280"><font color="red">*</font>退单日期：</td>
            <td width="250">
                <#if (purchaseVO.purchaseDate)?exists>
                <input type="text" name="orderDate" readOnly="readOnly" value="${purchaseVO.purchaseDate?string("yyyy-MM-dd")}" maxlength="60" class="_dateField _req input-text lh30" size="8">
                <#else>
                <input type="text" name="orderDate" readOnly="readOnly" value="" maxlength="60" class="_dateField _req input-text lh30" size="20">
                </#if>
            </td>
            <td class="td_right" width="200">退单状态：</td>
        ...
        <tr>
            ...
            <td>
                ...
                <input type="hidden" id="supplierType" value="Purchase" name="supplierType">
            ...
            <td class="td_right" ><font color="red">*</font>退单税率：</td>
            <td>
                <div class="select_border">
                    <div class="select_containers">
                        <span class="fl">
                            <select class="_req select" name="rate" style="width:140px;">
            ...
            <td>
                <div class="select_border">
                    <div class="select_containers">
                        <span class="fl">
                            <select class="_req select" name="currency" style="width:150px;">
                                <#list supplierCurrencyTypes?keys as key>
                                <#if key==purchaseVO.currency>
                                <option value="${key}" selected ="selected"> ${supplierCurrencyTypes[key]}</option>
                                <#else>
        ...
        <tr>
            ...
            <div class="select_border">
                ...
                <input type="text" name="expectDate" value="${purchaseVO.expectDate?string("yyyy-MM-dd")}" class="_dateField _req input-text lh30" size="20"/>
                <#else>
            ...
            <td >
                <input type="text" name="exchangeRate" value="${(purchaseVO.exchangeRate)!}" maxlength="60" class="_req input-text lh30" size="10">CNY
            </td>
        </tr>
        
        <tr>
            <td class="td_right"><font color="red">*</font>退单类型：</td>
            <td>
                <div class="select_border">
                <div class="select_containers">
                    <span class="fl">
