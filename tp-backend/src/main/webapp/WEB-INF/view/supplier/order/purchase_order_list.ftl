...
<@backend title="采购订单列表" 
    js=['/statics/supplier/js/common.js',
        '/statics/backend/js/jqueryui/js/jquery-ui-1.9.2.custom.min.js',
        '/statics/backend/js/jqueryui/i18n/jquery.ui.datepicker-zh-CN.js',
        '/statics/supplier/js/validator.js',
        '/statics/supplier/js/web/purchase_order_list.js'
       ] 
    css=['/statics/backend/js/jqueryui/css/cupertino/jquery-ui-1.9.2.custom.min.css'] >
            <div class="box_top">
                <b class="pl15">采购管理->采购->采购订单</b> 
            </div>
            	<!--by zhs 修改action。原 action="/supplier/purchaseorderList.htm" -->
                <form id="purchase_order_list_form" class="jqtransform" action="${domain}/supplier/purchaseorderList.htm" method="post">
                    <table cellspacing="0" cellpadding="0" border="0" width="100%"
                        ...
                        <tbody>
                            ...
                            <tr>
                               <td class="td_right" align="left">采购订单编号：</td>
                                <td class="" align="left">
                            ...
                            <tr>
                                ...
                                <td align="left" colspan="7">
                                   <input type="text" name="startTime" id="c_starDate_5"  class="_dateField input-text lh30" size="20" value="<#if purchaseDO.startTime??>${purchaseDO.startTime?string("yyyy-MM-dd")}</#if>">&nbsp;~&nbsp;<input type="text" id="c_endDate_5" name="endTime" class="_dateField input-text lh30" size="20" value="<#if purchaseDO.endTime??>${purchaseDO.endTime?string("yyyy-MM-dd")}</#if>">
                                </td>
                            </tr>

                            <tr>
                                <td colspan="8" align="center"><input type="reset" id="purchaseOrderListQueryReset"
                                    name="button" class="btn btn82 btn_res" value="重置">
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                                    <input type="button"
                                        name="button" id="purchaseOrderListQuery" class="btn btn82 btn_search" value="查询">
                                </td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <div class="search_bar_btn  pt10 pb10 box_border" style="padding-left:5px;">
                		<input type="button" name="button" id="purchase_order_list_add" class="btn btn82 btn_add" value="新增">
            		</div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr align="center" class="tr"
                                            ...
                                            <td>
                                                ...
                                                <#elseif sl.auditStatus==5><a href="javascript:void(0)" onclick="showEditPage(${sl.id})">编辑</a>
                                                <#else>
            ...
            <@pager  pagination=page  formId="purchase_order_list_form"  /> 
                </form>
