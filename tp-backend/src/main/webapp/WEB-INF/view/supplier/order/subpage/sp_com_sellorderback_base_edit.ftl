<table cellspacing="0" cellpadding="0" border="0" width="100%" class="form_table pt15 pb15">
    <tbody>
        <tr>
            ...
            <td class="td_right" align="left"><font color="red">*</font>退单日期：</td>
            <td width="250">
        ...
        <tr>
            ...
            <td>
                ...
                <input type="text" size="10" value="${(purchaseVO.supplierName)!}" class="input-text lh30" id="all_page_add_supplier_name" name="supplierName">
        ...
        <tr>
            ...
            <td>
                ...
                <input type="text" size="10" class="input-text lh30" value="${(purchaseVO.warehouseName)!}" id="pur_order_add_warehouse_name" name="warehouseName">
