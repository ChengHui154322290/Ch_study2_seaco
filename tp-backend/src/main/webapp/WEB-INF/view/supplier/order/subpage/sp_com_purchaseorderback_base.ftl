<table cellspacing="0" cellpadding="0" border="0" width="100%" class="form_table pt15 pb15">
    <tbody>
        <tr>
            <td class="td_right" width="">退货单编号： </td>
            <td class=""  width="350">
                <span>系统自动生成</span>
            </td>
            <td class="td_right" align="left" ><font color="red">*</font>退单日期：</td>
            <td width="250">
                <input type="text" name="orderDate" value="" maxlength="60" class="_dateField _req input-text lh30" size="20">
            </td>
        ...
        <tr>
            ...
            <td >
                <input type="text" name="exchangeRate" value="1" maxlength="60" class="_req input-text lh30" size="10">CNY
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="td_right" align="left" width="16%">备注：</td>
            <td width="16%">
                <input type="text" name="orderDesc" value="" maxlength="60" class="input-text lh30" size="20">
            </td>
            
             <td class="td_right" width="16%">
                <input value="1" name="isConfirm" type="checkbox">退单已确认
             </td>
             <td>
             </td>
        </tr>
