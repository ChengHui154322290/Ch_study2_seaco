<table cellspacing="0" cellpadding="0" border="0" width="100%" class="form_table pt15 pb15">
    <tbody>
        <tr>
            <td class="td_right" width="">采购订单编号： </td>
            <td class=""  width="340">
                <span>系统自动生成</span>
            </td>
            <td class="td_right" align="left" width=""><font color="red">*</font>订单日期：</td>
            <td width="240">
                <input type="text" name="orderDate" value="" maxlength="60" defaultDate="nowDay" class="_dateField _req input-text lh30" size="20">
            </td>
            
            <td class="td_right" width="">订单状态：</td>
            <td align="left" width="">新建
            </td>
        </tr>
        <tr>
            <td class="td_right" align="center" width=""><font color="red">*</font>供应商：</td>
            <td width="360">
            ...
            <td class="td_right" width=""><font color="red">*</font>进项税率：</td>
            <td width="">
            ...
            <td class="td_right" width=""><font color="red">*</font>币别：</td>
            <td width="">
            <div class="select_border">
                <div class="select_containers">
                    <span class="fl">
        ...
        <tr>
            <td class="td_right" align="center" width=""><font color="red">*</font>仓库： </td>
            <td width="">
            ...
            <td class="td_right" width=""><font color="red">*</font>期望日期：</td>
            <td width="">
            <div class="select_border">
            ...
            <td class="td_right" align="left" width=""><font color="red">*</font>汇率：</td>
            <td width="">
                <input type="text" name="exchangeRate" value="1" maxlength="60" id="exchangeRateId" class="_req _price input-text lh30" size="10">CNY
            </td>
        </tr>
        
        <tr>
        	<td class="td_right" width=""><font color="red">*</font>订单类型：</td>
        	<td width="">
        		<div class="select_border">
	                <div class="select_containers">
	                    <span class="fl">
        	...
        	<td class="td_right" align="left" width="">备注：</td>
            <td width="">
