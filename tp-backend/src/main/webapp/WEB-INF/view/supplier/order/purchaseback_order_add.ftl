...
<@backend title="新增采购退货单" js=[
        ...
        '/statics/supplier/js/web/purchaseback_order_add.js'] 
...
.pb15 {
    ...
    <div class="box">
        <div class="box_border">
            <div class="box_top">
                <b class="pl15">新增采购退货单</b>
            </div>
            <div class="box_center" style="margin-bottom: 30px;">
            	<!--by zhs 修改action。原action="/supplier/purchaseorderbackSave.htm" -->
                <form class="jqtransform" action="${domain}/supplier/purchaseorderbackSave.htm" id="order_form">
                    <#include "/supplier/order/subpage/sp_com_purchaseorderback_base.ftl" />
                    <#include "/supplier/order/subpage/sp_com_purchaseorderback_item.ftl" />
