    ...
    <table  cellspacing="0" cellpadding="0" width="100%" class="list_table CRZ">
        ...
        <tbody id="sp_order_table_body_2">
            ...
            <tr align="center" id="addQuotaItemTr2_${countIndex}">
                ...
                <td>
                    <#if  product.tariffRate == null || product.tariffRate == ""><#--非进口-->
...
<div class="search_bar_btn" width="100%"  style="text-align:right;">
    <table style="width:100%;">
        <tr>
            <td><#-- 可用量:<input type="text" name="totalAvailable" value="" maxlength="60" class="_req input-text lh30" size="20"> -->
            </td>
            <td><#-- 入库数量：
                <input type="text" name="totalStorage" value="" maxlength="60" class="_req input-text lh30" size="20"> -->
            </td>
            <td><font color="red">*</font>数量合计：
