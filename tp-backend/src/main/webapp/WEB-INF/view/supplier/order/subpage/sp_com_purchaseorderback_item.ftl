...
<div class="mt10" id="button">
   <input type="button" onclick="addOrderItem()" value="新增" class="btn btn82 btn_add" name="button"> 
</div>
<hr style="border: 1px dashed #247DFF;">
<div class="page">
...
<div id="gallery1">
    <table  cellspacing="0" cellpadding="0" width="100%" class="list_table CRZ" >
        ...
        <tbody id="sp_order_table_body_1">
			 <#----by zhs 01162149 purchaseVO.productList 修改为 purchaseVO.purchaseProductList------->
             ...
             <tr align="center" id="addQuotaItemTr_${countIndex}">
                ...
                <td>
                    <input type="text" size="5" value="${(product.standardPrice?c)!}" name="standardPrice" readOnly="readOnly" class="_req input-text lh30">
                </td>
                <td>
                    <input type="text" size="5" value="${(product.discount?c)!}" name="discount" readOnly="readOnly" class="_req input-text lh30">
                </td>
                <td>
                    <input type="text" size="5" value="${(product.orderPrice?c)!}" name="orderPrice" readOnly="readOnly" class="_req input-text lh30">
                </td>
                <td>
                    <input type="text" size="5" value="${(product.subtotal?c)!}" name="subtotal" readOnly="readOnly" class="_req input-text lh30">
                </td>
                <td style="background-color:#DDD;">${(product.storageCount)!}</td>
                <td>
                    <input type="button" value="删除" onclick="deleteThisProductTr(${countIndex})" class="ext_btn">
                    ...
                    <input type="hidden" name="storageCount" value="${product.storageCount}">
                    <input type="hidden" name="numberReturns" value="${product.numberReturns}">
