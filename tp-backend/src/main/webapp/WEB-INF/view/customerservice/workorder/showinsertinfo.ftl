...
<div class="box_center">
   <table width="100%" cellspacing="0" cellpadding="0" border="0" class="form_table pt15 pb15">
    ...
    <tr> 
      ...
      <td><select id="supplierMethodId" class="select" name="methodId">
		...
		<script>
              ...
              setSelectByValue(document.getElementById('supplierMethodId'),'${workorderInfo.supplierMethodId}');
              </script>
		</td>
   ...
   <input type="hidden" name="group" value="${workorderInfo.groupId}" />
