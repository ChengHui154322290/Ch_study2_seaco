            	...
            	<form class="jqtransform" method="post" id="reviewEdit">
            		<table class="form_table" border="0" cellpadding="0" cellspacing="0">
						...
						<tr>
							<td>评论日期:</td>
							<td>
								${review.createTime?string("yyyy-MM-dd HH:mm:ss")}
							</td>
						</tr>
						<tr>
							<td>分值:</td>
							<td valign="middle" align="left">
								<input type="radio" name="mark" <#if review.mark="5"> checked="checked"</#if> value="5"/>
            		...
            		<div id="div1_submit" style="text-align:center;">
						<input class="btn btn82 btn_save2" type="button" value="保存" onclick="upd(this)" />
