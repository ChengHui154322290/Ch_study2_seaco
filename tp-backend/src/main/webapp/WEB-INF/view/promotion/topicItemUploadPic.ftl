...
<@backend title="上传商品图片" 
		js=['/statics/backend/js/promotion/promotionItem_upload.js',
		...
		<table cellspacing="0" cellpadding="0" border="0" width="100%" class="form_table pt15 pb15">
			...
			<tr>
				...
				<td  width="80%" align="left">
					...
					<input type="hidden" id="selectItemIndex" value="${itemIndex}" />
					<input type="hidden" id="control" value="${controlName}" />
					<input type="hidden" id="fullControl" value="${fullControlName}" />
