  			...
  			<table id="topicSearch" cellspacing="0" cellpadding="0" border="0" width="100%" class="form_table pt15 pb15">
  				<tbody>
	  				<tr>     	 
						...
						<td class="" width="150" align="left"><input type="text" id="id" name="id" class="input-text lh30 topicInteger" /></td>
						<td class="td_right" width="50" align="right">专场编号:</td>
						<td class="" width="150" align="left"><input type="text" id="number" name="number" class="input-text lh30 topicInteger" /></td>
