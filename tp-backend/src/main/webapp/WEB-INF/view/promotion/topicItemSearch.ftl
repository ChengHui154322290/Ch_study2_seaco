		...
		<table cellspacing="0" cellpadding="0" border="0" width="100%" class="form_table pt15 pb15">
			<tr>
				...
				<td  width="50" align="left">
					<input type="text" class="input-text lh30" class="input-text lh30" id="barcode" value="${itemBarCode!}" />
				</td>
				<td><input type="button" class="btn btn82 btn_search" id="barcodeSearch" value="查询" /></td>
			</tr>
			<tr>
				<td colspan="3">
