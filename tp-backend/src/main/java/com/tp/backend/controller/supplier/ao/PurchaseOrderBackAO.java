...
@Service
public class PurchaseOrderBackAO extends SupplierOrderBaseAO {
    ...
    private void generateBaseInfo(final PurchaseInfo purchaseDTO, final Map<String, Object> resultMap,
        ...
        final String orderType = PurcharseType.PURCHARSE_RETURN.getValue();
        /** 订单类型：一般订单、紧急订单 */
        ...
        purchaseDTO.setCreateUser(SupplierUtilAO.getCurrentUserName());
        // by zhs 01162133 增加 setUpdateUser
        purchaseDTO.setUpdateUser(SupplierUtilAO.getCurrentUserName());
