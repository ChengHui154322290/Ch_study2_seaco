package com.tp.constant.common;
 ...
 *
 */
public final class ExceptionConstant implements Serializable {

	private static final long serialVersionUID = -6082166888287707359L;
	
	/**
	 * 异常层级
	 * @author szy
	 * 1-警告，2-验证不通过，3-业务流程（平台）异常，4-系统（原生）异常，5-不可修复错误
	 * 
	 */
	public static enum EXCEPTION_LEVEL{
		/**1-警告*/
		WARN(1),
		/**2-验证不通过*/
		VALIDATE(2),
	...
	public enum ErrorCode {
		...
		/** 收货地址对多可以添加5个*/
		CONSIGNEE_ADDRESS_MAX_FIVE(4001, "收货地址最多可添加" + 5 + "个"),
