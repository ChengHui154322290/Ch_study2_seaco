...
public enum OrderAuditStatus {
     ...
     */
    PURCHARSE_FINISHED("订单完成", "Order_finished", 7, "订单完成", new HashSet<Integer>(Arrays.asList(new Integer[] { 4 })));
    ...
    private OrderAuditStatus(final String name, final String value, final Integer status, final String result, final Set<Integer> preStatus) {
        this.name = name;
        this.value = value;
        this.status = status;
        this.result = result;
