...
<@sellContent title="" js=[
		'/static/scripts/item/item-spec-spu.js'
	] 
	 >
	<div class="box_border">
		<div class="box_top">
			<b class="pl15">商品规格(最多选择三个规格组)</b>
			<input name="selectSpec" id="selectSpec" value="" type="checkbox">是否均码
		</div>
	</div>	
	   <table class="table table-bordered table-striped table-hover" >       
		...
		<table class="table table-bordered table-striped table-hover" style="height:50px;">            
				<tr>   
					<td>
						<td><input type="button" class="btn btn-default" id="selectAttributeForSpu"  value="确定规格" /></td>  
					</td>    
       			</tr>
   		 </table>	  
