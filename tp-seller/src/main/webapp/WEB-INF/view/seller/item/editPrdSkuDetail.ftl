    ...
    <div class="panel-body">
	     ...
	     <table width="100%" height="50px;" class="table table-bordered">
	        ...
	        <br>
	         	 ...
	         	 <#if  editFlag ??>
	         	 		<div style="margin-top;50px;height:50px; line-height:30px;text-align:center;">    
		         			<input type="button" class="btn btn-default" value="保存" id="savePrdWithSpu" style="margin-left:300px;" />&nbsp;
							<input type="button" class="btn btn-default" value="提交审核" id="submitPrdWithSpu"/>   
	         			</div>
	         	</#if>
    </div><#-- panel-body -->
</div>
