...
<@sellContent title="首页" 
    css=['/static/css/item-ul.css',
     '/static/css/item-detail.css']>
   	<script type="text/javascript" src="/static/scripts/item/listSellerItem.js"></script>       
    ...
    <div class="panel-body">
        <form class="form-inline" role="form" id="searchFormId">
	      	...
	      	<tr>
	      		<td width="20%">备注：</td>
	      		<td >
		      			 <input type="text"  value="${majorInfo.infoOpenDto.remark}" disabled/>
	      		</td>
	      	</tr>
	    </table>
	      ...
	      <table width="100%" height="50px;" class="table table-bordered"> 
	       ...
	       <table width="100%" height="50px;" class="table table-bordered">
	          <b class="pl15">sku信息</b>
	       			<td width="10%">sku编码:</td>
					<td><input type="text" value="${majorInfo.skuDto.sku}" disabled /></td>
					<td width="20%">sku市场价:</td>
					<td><input type="text" value="${majorInfo.skuDto.basicPrice}" disabled /></td>
	        </table>
    </div><#-- panel-body -->
</div>
</form> 
