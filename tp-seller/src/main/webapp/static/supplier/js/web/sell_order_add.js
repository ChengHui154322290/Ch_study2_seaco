jQuery(function(){
		...
		$.ajax({
			...
			success:function(resultInfo){
				if(resultInfo.success){
					...
					window.location.href=domain+'/supplier/sellorderList';
				}else{
	...
	jQuery("#orderAddSub").click(function(){
		...
		var form = jQuery("#order_form");
		$.ajax({
			url:domain+"/supplier/sellOrderSub.htm",
			data:form.serialize(),
			dataType:'json',
			type:'post',
			success:function(resultInfo){
	...
	jQuery("#quotationShowAudit").click(function(){
		...
		ajaxRequest({
			method:'post',
			url:'/supplier/sellOrderExam/auditPage.htm',
			data:{"quoId":quoId},
	...
	jQuery("#quotationShowCancel").click(function(){
		confirmBox('确定取消？',function(){
			...
			var form = jQuery("#order_form");
			$.ajax({
				url:domain+"/supplier/sellOrderCancel.htm",
				data:form.serialize(),
				dataType:'json',
				type:'post',
				success:function(resultInfo){
...
function addOrderItem(){
	...
	ajaxRequest({
		...
		url:'/supplier/sellorder/getItemInfoForm.htm',
		success:function(data){
