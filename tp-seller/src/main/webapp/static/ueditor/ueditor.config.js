...
(function () {
     ...
     */
    var URL = window.UEDITOR_HOME_URL || "/statics/ueditor/";
    ...
    window.UEDITOR_CONFIG = {
        ...
        UEDITOR_HOME_URL : backendDomain+URL

        //图片上传配置区
        ,imageUrl:"http://up.qiniu.com/"            //图片上传提交地址
        ,imagePath:bucketURL                    //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
        //七牛结合需要改成file
        ...
        ,imageManagerPath: bucketURL                                    //图片修正地址，同imagePath
        ...
        , toolbars:[
            ['fullscreen', 'source', '|', 'undo', 'redo', '|',
                ...
                'insertimage', 'horizontal', 'date', 'time', 'spechars', 'wordimage', 'help']
        ]
