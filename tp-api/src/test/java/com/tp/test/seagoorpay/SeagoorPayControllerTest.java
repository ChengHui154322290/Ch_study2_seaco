...
import com.tp.m.helper.SeagoorPayHelper;
import com.tp.m.query.seagoorpay.*;
import com.tp.m.util.JsonUtil;
import com.tp.m.vo.seagoorpay.SeagoorPayCodeVO;
...
public class SeagoorPayControllerTest  extends BaseTest {
    ...
    public void pay() throws Exception {
        ...
        order.setMer_trade_code("46361999990005102641");
       ...
       // order.setDevice_info("2楼1号收银台");
        order.setPay_code("907514278403785815");
        order.setRand_str("0.8542095736038015");
        order.setTotal_fee(10);
        System.out.println(SeagoorPayHelper.sign(order,"sign"));
