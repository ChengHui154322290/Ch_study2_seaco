...
function registr() {
    ...
    $('.register-register')[xigou.events.click](function () {
        ...
        if(xigou.getSessionStorage("advertisementFrom")!="" && xigou.getSessionStorage("advertisementFrom")!=null){
        	 params.advertFrom=xigou.getSessionStorage("advertisementFrom");
        }
