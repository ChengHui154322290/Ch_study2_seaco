...
(function($) {
	...
	//用户领取优惠卷中心列表
	me.activeUser.receiveCenterlist = function(params){
		var path = me.activeHost + me.activeUrl.coupon.receiveCenterlist;
		ajaxPost(params, path);
	}
	
	//用户领取优惠卷
	me.activeUser.receiveCoupon = function(params){
		var path = me.activeHost + me.activeUrl.coupon.receiveCoupon;
		ajaxPost(params, path);
	}
