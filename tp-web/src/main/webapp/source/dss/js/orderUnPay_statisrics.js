/*
* @Author: dongqian
* @Date:   2017-05-09 17:15:38
* @Last Modified by:   dongqian
* @Last Modified time: 2017-05-11 11:22:25
*/
...
var unpayorder_max = "N";

function unpayOrders(page, me){
        ...
        xigou.promoterFunc.queryOrders({
            ...
            if (status == xigou.dictionary.success) {
                if (null == response) {
                    ...
                    if(0 == code){
                        setUnpayOrderHtmlView(response, page);
...
function setUnpayOrderHtmlView(json, page) {
    var o = json,
