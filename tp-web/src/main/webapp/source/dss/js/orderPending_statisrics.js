/*
* @Author: dongqian
* @Date:   2017-05-09 17:16:08
* @Last Modified by:   dongqian
* @Last Modified time: 2017-05-11 11:22:18
*/
...
var deliveryorder_max = "N";

function deliveryOrders(page, me){

    if(deliveryorder_max == "Y"){
        ...
        xigou.promoterFunc.queryOrders({
            ...
            if (status == xigou.dictionary.success) {
                if (null == response) {
                    ...
                    if(0 == code){
                        setDeliveryOrderHtmlView(response, page);
...
function setDeliveryOrderHtmlView(json, page) {
    var o = json,
