...
import com.tp.model.mmp.AreaDO;
...
public class TopicChangeDetailDTO implements Serializable {
	...
	/** 专题的基本信息 */
	private TopicChange topic; // 专题的基本信息
	/** 专题所包含的商品 */
	private List<TopicItemChange> topicItemList; // 专题所包含的商品
	...
	private PolicyChange policy;// 专题所包含的限购政策
	...
	private List<TopicChangeAuditLog> auditLogList; // 审批记录
	
	private List<TopicCouponChangeDTO> couponList; // 优惠券列表
	...
	public void setTopic(TopicChange topic) {
		if (null != topic) {
	...
	public List<TopicItemChange> getPromotionItemList() {
		return topicItemList;
	}

	public void setPromotionItemList(List<TopicItemChange> promotionItemList) {
	...
	public PolicyChange getPolicy() {
		...
		if (null != policy) {
			...
			policy.setByRegisterTime("on".equalsIgnoreCase(byRegisterTimeValue) ? 1
					: 0);
	...
	public void setPolicy(PolicyChange policy) {
		this.policy = policy;
	}
	 ...
	 */
	public void setTopicItemList(List<TopicItemChange> topicItemList) {
	 ...
	 */
	public List<TopicChangeAuditLog> getAuditLogList() {
		return auditLogList;
	}
	 ...
	 */
	public void setAuditLogList(List<TopicChangeAuditLog> auditLogList) {
	...
	/**
	 * @param topicInterestedImageFull the topicInterestedImageFull to set
	 */
	...
	/**
	 * @param topicHitaoImageFull the topicHitaoImageFull to set
	 */
	 ...
	 */
	public List<TopicCouponChangeDTO> getCouponList() {
		return couponList;
	}
	 ...
	 */
	public void setCouponList(List<TopicCouponChangeDTO> couponList) {
	...
	/**
	 * @param pcImageFull the pcImageFull to set
	 */
	...
	/**
	 * @param pcInterestImageFull the pcInterestImageFull to set
	 */
	...
	/**
	 * @param mobileImageFull the mobileImageFull to set
	 */
	...
	/**
	 * @param mallImageFull the mallImageFull to set
	 */
	...
	/**
	 * @param haitaoImageFull the haitaoImageFull to set
	 */
