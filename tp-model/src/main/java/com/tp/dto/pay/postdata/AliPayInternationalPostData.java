 ...
 *          zhouhui Exp $
 */
public class AliPayInternationalPostData
		implements
			Serializable,
			PayPostData,
			AppPayData {
	...
	public AliPayInternationalPostData() {

	}

	public AliPayInternationalPostData(Properties paymentConfig, PaymentInfo dto) {
		this.partner = paymentConfig
				.getProperty("ALIPAY_INTERNATIONAL_PARTNER");
