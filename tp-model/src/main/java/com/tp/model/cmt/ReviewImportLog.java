...
/**
  ...
  * 商品评论导入日志表
  */
public class ReviewImportLog extends BaseDO implements Serializable {
	...
	/**导入日志状态:1-解析excel,2-验证excel,3-插入sku,4-记录日志 数据类型tinyint(4)*/
	private Integer status;
	
	/**逻辑删除标志：1-不删除，0-删除，默认1 数据类型tinyint(4)*/
