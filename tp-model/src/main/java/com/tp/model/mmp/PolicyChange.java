...
/**
  ...
  * 限购政策
  */
public class PolicyChange extends BaseDO implements Serializable {
	...
	/**变更策略Id 数据类型bigint(18)*/
	private Long policyChangeId;
	...
	public void setPolicyChangeId(Long policyChangeId){
