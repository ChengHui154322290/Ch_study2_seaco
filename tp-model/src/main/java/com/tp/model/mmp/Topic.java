...
public class Topic extends BaseDO implements Serializable {
    ...
    /**
     * 销售模式 1-不限 2-旗舰店 3-西狗国际商城 4-洋淘派 5-闪购 6-秒杀 7-阶梯团 8-商品试用 数据类型tinyint(4)
     */
    ...
    /**
     * 排序位置锁定状态 0-未锁定 1-锁定 数据类型tinyint(4)
     */
    private Integer sortLockStatus;
     ...
     * wap排序 数据类型bigint(18)
     */
    private Long wapIndex;

    /**
     * ios排序 数据类型bigint(18)
     */
    private Long iosIndex;

    /**
     * 安卓排序 数据类型bigint(18)
     */
    private Long androidIndex;

    /**
     * 微信排序 数据类型bigint(18)
     */
    private Long wxIndex;
    ...
    public Integer getSortLockStatus() {
        return sortLockStatus;
    }
    ...
    public Long getWapIndex() {
        return wapIndex;
    }

    public Long getIosIndex() {
        return iosIndex;
    }

    public Long getAndroidIndex() {
        return androidIndex;
    }

    public Long getWxIndex() {
        return wxIndex;
    }
    ...
    public void setSortLockStatus(Integer sortLockStatus) {
        this.sortLockStatus = sortLockStatus;
    }
    ...
    public void setWapIndex(Long wapIndex) {
        this.wapIndex = wapIndex;
    }

    public void setIosIndex(Long iosIndex) {
        this.iosIndex = iosIndex;
    }

    public void setAndroidIndex(Long androidIndex) {
        this.androidIndex = androidIndex;
    }

    public void setWxIndex(Long wxIndex) {
