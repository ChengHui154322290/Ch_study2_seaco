 ...
 */
@Service
public class OrderImportInfoProxy {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(OrderImportInfoValidateProxy.class);
	...
	public void getTemplateDatas(HttpServletRequest request,
       ...
       if("FROM_SUPPLIER_SYS".equals(downLoadFrom)){
		...
		response.addHeader("Content-Disposition", "attachment; filename="
				+ "import_sku.xls");
		String savePath =  OrderImportInfoValidateProxy.class.getResource("/").getPath()+excelPath;
		if(waveSign.equals(WAVESIGN)){
			savePath =  OrderImportInfoValidateProxy.class.getResource("/").getPath()+hitaoExcelPath;
		}
