...
public interface ContractSettlementRuleDao extends BaseDao<ContractSettlementRule> {
	/**
	 * 根据合同ID更新状态及更新人
	 * @param contractId
	 * @param status
	 ...
	 */
	void batchInsert(List<ContractSettlementRule> contractSettlementRuleList);
}
